...
def two_step_pipeline(uri: str = 'https://data.cityofchicago.org/resource/wrvz-psew.csv', some_int: int = 1234):
...
if __name__ == '__main__':
    ...
    client.create_run_from_pipeline_func(two_step_pipeline, arguments={})
